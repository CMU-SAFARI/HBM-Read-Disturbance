...
def plotBokehLinePerRow(test, x_label='', y_label='', join_wrs=False, num_victims_in_wrs=1):
    ...
    button_common = Button(label="CopyCommon", button_type="default", max_width=30)
    
    button_common.js_on_click(CustomJS(args=dict(txt = test.get_iterations_with_common_REF()), code=js_clipboard_copy))

    button_copy_singleTRR = Button(label="CopySingleTRR", button_type="default", max_width=30)
    button_copy_singleTRR.js_on_click(CustomJS(args=dict(txt = test.get_iterations_with_single_REF()), code=js_clipboard_copy))


    # button_show_previous_run = Button(label="ShowPreviousRun", button_type="default", max_width=30)
    # button_show_previous_run.on_click(show_previous_run);    

    plots.append(button_common)
    plots.append(button_copy_singleTRR)
    return plots
